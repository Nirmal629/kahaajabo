            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" action="{{ route('admin.driver.update', $driver_details->id) }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="first_name"
                                    ...
                                    value="{{ old('first_name', $driver_details->first_name ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="last_name"
                                    ...
                                    value="{{ old('last_name', $driver_details->last_name ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="email" name="email"
                                    ...
                                    value="{{ old('email', $driver_details->email ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="phone_number" maxlength="10"
                                    ...
                                    value="{{ old('phone_number', $driver_details->phone_number ?? '') }}"
                                ...
                                <select id="country" class="form-select @error('country_id') is-invalid @enderror"
                                    ...
                                    @foreach ($countries as $countriesVal)
                                        <option value="{{ $countriesVal->id }}"
                                            {{ old('country_id', $driver_details->country_id ?? '') == $countriesVal->id ? 'selected' : '' }}>
                                ...
                                <select id="state_id" class="form-select @error('state_id') is-invalid @enderror"
                                    ...
                                    @foreach ($states as $statesVal)
                                        <option value="{{ $statesVal->id }}"
                                            {{ old('state_id', $driver_details->state_id ?? '') == $statesVal->id ? 'selected' : '' }}>
                                ...
                                <select id="district_id" class="form-select @error('district_id') is-invalid @enderror"
                                    ...
                                    @foreach ($district as $districtVal)
                                        <option value="{{ $districtVal->id }}"
                                            {{ old('district_id', $driver_details->district_id ?? '') == $districtVal->id ? 'selected' : '' }}>
                                ...
                                <select id="city_id" class="form-select @error('city_id') is-invalid @enderror"
                                    ...
                                    @foreach ($cities as $citiesVal)
                                        <option value="{{ $citiesVal->id }}"
                                            {{ old('city_id', $driver_details->city_id ?? '') == $citiesVal->id ? 'selected' : '' }}>
                                ...
                                <select id="area_id" class="form-select @error('area_id') is-invalid @enderror"
                                    ...
                                    @foreach ($area as $areaVal)
                                        <option value="{{ $areaVal->id }}"
                                            {{ old('area_id', $driver_details->area_id ?? '') == $areaVal->id ? 'selected' : '' }}>
                                ...
                                <select id="area_manager_id" class="form-select @error('area_manager_id') is-invalid @enderror"
                                    ...
                                    @foreach ($area_manager as $area_managerVal)
                                        <option value="{{ $area_managerVal->id }}"
                                            {{ old('area_manager_id', $driver_details->area_manager_id ?? '') == $area_managerVal->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="complete_address" rows="3" class="form-control">{{ old('complete_address', $driver_details->complete_address) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="aadhar_card_number" maxlength="12" class="form-control"
                                    value="{{ old('aadhar_card_number', $driver_details->aadhar_card_number) }}">
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($driver_details->aadhar_card_file)
                                        <a href="{{ asset('uploads/driver-document/' . $driver_details->aadhar_card_file) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="pan_card_number" class="form-control"
                                    value="{{ old('pan_card_number', $driver_details->pan_card_number) }}">
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($driver_details->pan_card_file)
                                        <a href="{{ asset('uploads/driver-document/' . $driver_details->pan_card_file) }}"
                                            target="_blank" class="btn btn-outline-primary text-nowrap">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bank_name" class="form-control"
                                    value="{{ old('bank_name', $driver_details->bank_name) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Account Holder Name</label>
                                <input type="text" name="account_holder_name" class="form-control"
                                    value="{{ old('account_holder_name', $driver_details->account_holder_name) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Account Number</label>
                                <input type="text" name="account_number" class="form-control"
                                    value="{{ old('account_number', $driver_details->account_number) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">IFSC Code</label>
                                <input type="text" name="ifsc_code" class="form-control"
                                    value="{{ old('ifsc_code', $driver_details->ifsc_code) }}">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($driver_details->bank_passBook_file)
                                        <a href="{{ asset('uploads/driver-document/' . $driver_details->bank_passBook_file) }}"
                                            target="_blank" class="btn btn-outline-primary text-nowrap">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="driving_license" class="form-control"
                                    value="{{ old('driving_license', $driver_details->driving_license) }}">
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4">
                                        @if ($driver_details->driving_license_file)
                                            <a href="{{ asset('uploads/driver-document/' . $driver_details->driving_license_file) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="license_start_date" class="form-control"
                                    value="{{ old('license_start_date', $driver_details->license_start_date) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">License End Date</label>
                                <input type="date" name="license_end_date" class="form-control"
                                    value="{{ old('license_end_date', $driver_details->license_end_date) }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="register_date" class="form-control"
                                    value="{{ old('register_date', $driver_details->register_date) }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Start Date</label>
                                <input type="date" name="start_date" class="form-control"
                                    value="{{ old('start_date', $driver_details->start_date) }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">End Date</label>
                                <input type="date" name="end_date" class="form-control"
                                    value="{{ old('end_date', $driver_details->end_date) }}">
                            </div>
