<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h4 class="logo-text">Kahaanjabo</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						<div class="parent-icon"><i class="fadeIn animated bx bx-flag"></i>
						</div>
						<div class="menu-title">Location Management</div>
					</a>
						<ul>
							<li><a href="{{ route('admin.country.index') }}"><i class='bx bx-radio-circle'></i> Country</a></li>
							<li><a href="{{ route('admin.state.index') }}"><i class='bx bx-radio-circle'></i> State</a></li>
							<li><a href="{{ route('admin.district.index') }}"><i class='bx bx-radio-circle'></i> District</a></li>
							<li><a href="{{ route('admin.city.index') }}"><i class='bx bx-radio-circle'></i> City</a></li>
							<li><a href="{{ route('admin.area.index') }}"><i class='bx bx-radio-circle'></i> Area</a></li>
						</ul>
				</li>
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						...
						<div class="menu-title">Area Manager</div>
					</a>
						<ul>
							<li><a href="{{ route('admin.area-manager.index') }}"><i class='bx bx-radio-circle'></i>Area Manager List</a></li>
						</ul>
				</li>

				<li>
					<a href="{{ route('admin.car-owner.index') }}">
						<div class="parent-icon"> <i class="bx bx-car"></i>
						</div>
						<div class="menu-title">Car Owner</div>
					</a>
				</li>
				
				<li>
					<a class="" href="{{ route('admin.vehicle-details.index') }}">
						<div class="parent-icon"><i class="fadeIn animated bx bx-car"></i>
						</div>
						<div class="menu-title">Vehicle Details</div>
					</a>
				</li>

				<li>
					<a class="" href="{{ route('admin.driver.index') }}">
						<div class="parent-icon"><i class="fadeIn animated bx bx-car"></i>
						</div>
						<div class="menu-title">Driver Details</div>
					</a>
				</li>
				

				<li>
					<a href="{{ route('admin.requestCall.index') }}">
						<div class="parent-icon"> <i class="bx bx-phone-call"></i>
						</div>
						<div class="menu-title">Request A Call</div>
					</a>
				</li>
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						...
						<div class="menu-title">Frontend Dynamic</div>
					</a>
					<ul>
						<li><a href="{{ route('admin.vehicle-types.index') }}"><i class='bx bx-radio-circle'></i>Vehicle Types</a></li>
					</ul>
					<ul>
						<li><a href="{{ route('admin.vehicle-rates.index') }}"><i class='bx bx-radio-circle'></i>Vehicle Rates</a></li>
					</ul>
					<ul>
						<li><a href="{{ route('admin.home.dynamic') }}"><i class='bx bx-radio-circle'></i>Home Content</a></li>
					</ul>
					<ul>
						<li><a href="{{ route('admin.contact-us.index') }}"><i class='bx bx-radio-circle'></i>Contact Us</a></li>
					</ul>
				</li>
