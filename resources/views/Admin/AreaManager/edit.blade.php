...
@section('main_content')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Update Area Manager Details</div>
            ...
            <div class="col-md-12 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" action="{{ route('admin.area-manager.update', $area_manager->id) }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="first_name"
                                    ...
                                    value="{{ old('first_name', $area_manager->first_name ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="last_name"
                                    ...
                                    value="{{ old('last_name', $area_manager->last_name ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="email" name="email"
                                    ...
                                    value="{{ old('email', $area_manager->email ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="phone_number" maxlength="10"
                                    ...
                                    value="{{ old('phone_number', $area_manager->phone_number ?? '') }}"
                                ...
                                <select id="country" class="form-select @error('country_id') is-invalid @enderror"
                                    ...
                                    @foreach ($countries as $countriesVal)
                                        <option value="{{ $countriesVal->id }}"
                                            {{ old('country_id', $area_manager->country_id ?? '') == $countriesVal->id ? 'selected' : '' }}>
                                ...
                                <select id="state_id" class="form-select @error('state_id') is-invalid @enderror"
                                    ...
                                    @foreach ($states as $statesVal)
                                        <option value="{{ $statesVal->id }}"
                                            {{ old('state_id', $area_manager->state_id ?? '') == $statesVal->id ? 'selected' : '' }}>
                                ...
                                <select id="district_id" class="form-select @error('district_id') is-invalid @enderror"
                                    ...
                                    @foreach ($district as $districtVal)
                                        <option value="{{ $districtVal->id }}"
                                            {{ old('district_id', $area_manager->district_id ?? '') == $districtVal->id ? 'selected' : '' }}>
                                ...
                                <select id="city_id" class="form-select @error('city_id') is-invalid @enderror"
                                    ...
                                    @foreach ($cities as $citiesVal)
                                        <option value="{{ $citiesVal->id }}"
                                            {{ old('city_id', $area_manager->city_id ?? '') == $citiesVal->id ? 'selected' : '' }}>
                                ...
                                <select id="area_id" class="form-select @error('area_id') is-invalid @enderror"
                                    ...
                                    @foreach ($area as $areaVal)
                                        <option value="{{ $areaVal->id }}"
                                            {{ old('area_id', $area_manager->area_id ?? '') == $areaVal->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="complete_address" rows="3" class="form-control">{{ old('complete_address', $area_manager->complete_address) }}</textarea>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="aadhar_card_number" maxlength="12" class="form-control"
                                    value="{{ old('aadhar_card_number', $area_manager->aadhar_card_number) }}">
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($area_manager->aadhar_card_file)
                                        <a href="{{ asset('uploads/area-manager/' . $area_manager->aadhar_card_file) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="pan_card_number" class="form-control"
                                    value="{{ old('pan_card_number', $area_manager->pan_card_number) }}">
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($area_manager->pan_card_file)
                                        <a href="{{ asset('uploads/area-manager/' . $area_manager->pan_card_file) }}"
                                            target="_blank" class="btn btn-outline-primary text-nowrap">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="bank_name" class="form-control"
                                    value="{{ old('bank_name', $area_manager->bank_name) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Account Holder Name</label>
                                <input type="text" name="account_holder_name" class="form-control"
                                    value="{{ old('account_holder_name', $area_manager->account_holder_name) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Account Number</label>
                                <input type="text" name="account_number" class="form-control"
                                    value="{{ old('account_number', $area_manager->account_number) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">IFSC Code</label>
                                <input type="text" name="ifsc_code" class="form-control"
                                    value="{{ old('ifsc_code', $area_manager->ifsc_code) }}">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($area_manager->bank_passBook_file)
                                        <a href="{{ asset('uploads/area-manager/' . $area_manager->bank_passBook_file) }}"
                                            target="_blank" class="btn btn-outline-primary text-nowrap">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="driving_license" class="form-control"
                                    value="{{ old('driving_license', $area_manager->driving_license) }}">
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4">
                                        @if ($area_manager->driving_license_file)
                                            <a href="{{ asset('uploads/area-manager/' . $area_manager->driving_license_file) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="license_start_date" class="form-control"
                                    value="{{ old('license_start_date', $area_manager->license_start_date) }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">License End Date</label>
                                <input type="date" name="license_end_date" class="form-control"
                                    value="{{ old('license_end_date', $area_manager->license_end_date) }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="register_date" class="form-control"
                                    value="{{ old('register_date', $area_manager->register_date) }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Start Date</label>
                                <input type="date" name="start_date" class="form-control"
                                    value="{{ old('start_date', $area_manager->start_date) }}">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">End Date</label>
                                <input type="date" name="end_date" class="form-control"
                                    value="{{ old('end_date', $area_manager->end_date) }}">
                            </div>
