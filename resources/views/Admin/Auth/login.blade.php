...
<!-- Mirrored from codervent.com/rukada/demo/vertical/ltr/auth-basic-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jun 2026 17:50:56 GMT -->
...
<head>
    ...
    <title>KAHAANJABO - Admin Login</title>
                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    ...
                                    <div class="text-center mb-4">
                                        <h5 class="">Kahaanjabo Admin</h5>
                                        <p class="mb-0">Please log in to your account</p>
                                    </div>
                                    <div class="form-body">
                                        <form class="row g-3" method="POST"
                                            action="{{ route('admin.authentication') }}">
                                            @csrf
                                            <div class="col-12">
